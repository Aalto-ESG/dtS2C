...
Feed data at fixed rate for different number of workers.

The aim is to find the maximum throughput for each worker amount. This experiment should fully saturate the cluster,
causing unreasonably high end-to-end latencies.
"""
